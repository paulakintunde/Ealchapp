...
export const THEME_META: Record<string, ThemeMeta> = {
  ...
  'recherche-emploi': { fr: 'Recherche d’emploi', en: 'Job search', subFr: '', subEn: '' },
  'systeme-de-sante': { fr: 'Le système de santé', en: 'Healthcare system', subFr: '', subEn: '' },
  'immigration-et-citoyennete': { fr: 'Immigration et citoyenneté', en: 'Immigration and citizenship', subFr: '', subEn: '' },
  'douane-et-immigration': { fr: 'Douane et immigration', en: 'Customs and immigration', subFr: '', subEn: '' },
  'examens-et-diplomes': { fr: 'Examens et diplômes', en: 'Exams and diplomas', subFr: '', subEn: '' },
  'quebec-et-francophonie': { fr: 'Québec et francophonie', en: 'Quebec and the Francophonie', subFr: '', subEn: '' },
