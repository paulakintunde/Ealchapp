...
export type Strings = {
  ...
  lessonDone: string; lessonSoon: string;
...
export const T: Record<Lang, Strings> = {
  fr: {
    ...
    lessonDone: 'Terminer la leçon', lessonSoon: 'Leçon bientôt disponible',
  ...
  en: {
    ...
    lessonDone: 'Finish the lesson', lessonSoon: 'Lesson coming soon',
