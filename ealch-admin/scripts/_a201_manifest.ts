...
/** An Item literal, with the fields the schema actually carries and nothing
 *  else. Undefined-valued keys are dropped rather than emitted as `undefined`,
 *  which is not valid in a `.ts` data file the seed merge round-trips. */
