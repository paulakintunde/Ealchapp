...
export const VERBES_ER_EXC: ExcSentence[] = [
  ...
  { id: 'fr.a2.verbes.162', kind: 'sentence', level: 'a2', theme: THEME, fr: "J'espère arriver avant midi.", en: 'I hope to arrive before midday.', ipa: '/ʒɛs.pɛʁ a.ʁi.ve a.vɑ̃ mi.di/', respell: 'zhes-PEHR a-ree-vay a-vahⁿ mee-DEE', person: 'je', pattern: 'e-er', moves: true, family: 'apply', tags: ['er-verb', 'stem-change', 'e-er', 'nasal'], drills: S, audioRef: null, version: 1, notes: 'j espère, and the verb after it stays in the naming form, which is a2.01 territory.' },
