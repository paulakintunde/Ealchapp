// DELF B2 tout public blanc-02 — the assembled paper.
//
...
// variant. That seeding is why blanc-01 and blanc-02 do not share a key
// sequence: five TEF papers once did, because the scatter keyed on the question
// index alone and every paper therefore scattered identically.
//
